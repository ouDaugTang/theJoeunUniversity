...
## **시연 영상**
[![Video Label](https://img.youtube.com/vi/uljVDL_yx3k/0.jpg)](https://www.youtube.com/watch?v=uljVDL_yx3k)

## **맡은 역할**

- **핵심 기능**
    - **로그인 기능**: 가상키보드 라이브러리를 적용해 터치로 로그인이 가능하게 하였습니다.
    - **이력서**: 한글 HTML변환을 이용해 로그인된 사용자의 값을 세션을 통해 매핑하였습니다.
    - **DB 구축**: 테이블 조인을 최대한 줄여 유지보수가 쉽고 효율적인 ERD를 만들었습니다.
